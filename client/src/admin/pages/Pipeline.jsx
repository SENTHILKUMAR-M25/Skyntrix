...
import {
  PRIORITIES, PRIORITY_MAP, STAGE_MAP, stageMeta, progressPercent, isOverdue, formatMoney, formatDate, initials,
} from "../utils/pipeline";
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="End-to-end lifecycle board: Lead to Support / Maintenance"
        action={
          <div className="flex items-center gap-2">
            <div className="hidden items-center gap-4 rounded-xl bg-white px-4 py-2 text-xs sm:flex">
